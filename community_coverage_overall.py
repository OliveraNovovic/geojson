...
def main():
    ...
    for i in range(1, 314):
        cid_array = [] #for each vornoi polygon we want to put all of it's (unique)cid's in one array
        ...
        print(vpoly, cid_array)
        vpc_area = vpoly_area(cid_array)[0]
        print(vpoly, vpc_area)
        print(vpoly, "max covered area in km^2 ", vpc_area/1000000)
        avg_vpc_area = vpoly_area(cid_array)[1]
        print(vpoly, "avg community area in km^2 ", avg_vpc_area/1000000)
